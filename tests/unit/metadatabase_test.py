...
@pytest.mark.parametrize(
    ...
    [
        ([], -1, StarCase.FIVE, 0, [Explanation.FoundNoListMatches]),
        (
                [0.5],
                -1,
                StarCase.ZERO,
        ...
        ([0.5], 0.5, StarCase.ZERO, 1, [Explanation.FoundListMatches]),
        ([0.5], 1, StarCase.ZERO, 1, [Explanation.FoundListMatches]),
        ([], 1, StarCase.FIVE, 0, [Explanation.FoundNoListMatches]),
    ],
)

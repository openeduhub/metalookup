...
class ExtractLinks(MetadataBase):
    ...
    malicious_extensions = ["msp", "cfxxe", "php3", "vb", "vb", "swf", "mcq", "dyv", "html", "ps1", "jar", "9", "ocx",
                            "chm", "mshxml", "vbs", "hta", "lkh", "hlp", "iws", "gadget", "pr", "wlpginstall", "kcd",
                            "docx", "dom", "hsq", "aepl", "0_full_0_tgod_signed", "dyz", "psc1", "py", "cyw", "blf",
                            "osa", "pdf", "shs", "xlm", "exe_renamed", "bat", "dll", "exe1", "pif", "xir", "vbs", "qrn",
                            "mjg", "fag", "xdu", "xlam", "com", "ps2xml", "reg", "cpl", "plc", "ska", "xlv", "bmw",
                            "msc", "tko", "rna", "msh2xml", "wmf", "hlw", "uzy", "nls", "inf", "iva", "zix", "gzquar",
                            "cxq", "ppam", "bps", "ppt", "dxz", "ezt", "jse", "xnxx", "xls", "exe", "aru", "lok", "hta",
                            "vba", "xltm", "atm", "xtbl", "txs", "xlsm", "mjz", "mfu", "wsf", "cih", "xnt", "capxml",
                            "docm", "sfx", "fjl", "cmd", "msh", "aut", "ws", "tti", "dlb", "msh1", "ozd", "fuj", "exe",
                            "class", "386", "qit", "ps2", "delf", "cla", "ps1xml", "bkd", "doc", "bin", "dev", "cc",
                            "sys", "dx", "vbx", "bup", "vxd", "rsc_tmp", "js", "spam", "tps", "htm", "wsh", "bll",
                            "sop", "wsc", "bxz", "jar", "tsa", "msi", "pcx", "vbe", "smm", "rhk", "dli", "application",
                            "let", "pid", "upa", "msh1xml", "ce0", "psc2", "msh2", "lpaq5", "ctbl", "boo", "js", "buk",
                            "hts", "sldm", "bat", "smtmp", "dllx", "ppsm", "docm", "bhx", "scf", "fnr", "pptm", "drv",
                            "doc", "vzr", "ssy", "scr", "dotm", "s7p", "ceo", "tmp", "lik", "lnk", "pgm", "dll", "oar",
                            "bqf", "zvz", "dbd", "vexe", "potm", "\u202e"]
    ...
    def __extract_malicious_extensions(self, extensions: list) -> list:
        return [extension for extension in extensions if extension.replace(".", "") in self.malicious_extensions]
